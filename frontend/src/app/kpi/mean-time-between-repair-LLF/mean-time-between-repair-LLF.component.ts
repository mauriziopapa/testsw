...
@Component({
    selector: 'mean-time-between-repair-LLF',
    imports: [BarChartModule, SharedModule],
    templateUrl: './mean-time-between-repair-LLF.component.html',
    styleUrls: ['./mean-time-between-repair-LLF.component.scss']
})
export class MeanTimeBetweenRepairLLFComponent extends AbstractKPIComponent {
  override name = 'mean-time-between-repair-LLF';
  override url = 'mean_time_between_repair';
  currentOptions: any;

  override searchByFilters(filters: any) {
    this.filters.tipology = 'LLF';
