...
const PuntualitaFornitoriCRMService = require('../../../services/kpi/PuntualitaFornitoriCRMService');
...
module.exports = () => {
  router.get('/', [isAuthenticated], async (req, res) => {
    try {
      ...
      const result = await PuntualitaFornitoriCRMService.getKpiValues({ from, to, fornitore });
      return res.json(result);
    } catch (error) {
      log.error(`Error getting kpi Puntualita Fornitori CRM: ${error.message}`, error);
