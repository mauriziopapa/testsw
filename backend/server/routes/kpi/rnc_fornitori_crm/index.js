...
const RNCFornitoriCRMService = require('../../../services/kpi/RNCFornitoriCRMService');
...
module.exports = () => {
  router.get('/', [isAuthenticated], async (req, res) => {
    try {
      ...
      const result = await RNCFornitoriCRMService.getKpiValues({ from, to, fornitore });
      return res.json(result);
    } catch (error) {
      log.error(`Error getting kpi RNC Fornitori CRM: ${error.message}`, error);
