...
const MotiviRinunciaNumeroService = require('../../../services/kpi/MotiviRinunciaNumeroService');
...
module.exports = () => {
  router.get('/', [isAuthenticated], async (req, res) => {
    try {
      ...
      const result = await MotiviRinunciaNumeroService.getKpiValues({ year, tipo_offerta });
      return res.json(result);
    } catch (error) {
      log.error(`Error getting kpi Motivi Rinuncia Numero Service: ${error.message}`, error);
