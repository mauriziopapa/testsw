...
const EmissioniMediaKPIService = require('../../../services/kpi/EmissioniMediaKPIService');
...
module.exports = () => {
  router.get('/', [isAuthenticated], async (req, res) => {
    try {
      ...
      const result = await EmissioniMediaKPIService.getKpiValues({ from, to, pde, kpi_id });
      return res.json(result);
    } catch (error) {
      log.error(`Error getting kpi media emissioni: ${error.message}`, error);
